...
public:
	...
	virtual void SetItalicStroke(bool phase, wchar_t error[], size_t errorLen); /* !phase => angle */
	...
	virtual void DStroke(bool leftStationary[], short knot[], short cvt, short *actualCvt, wchar_t error[], size_t errorLen); // new diagonal stroke
	virtual void IStroke(bool leftStationary[], short knot[], short height[], short phase, short cvt, short *actualCvt, wchar_t error[], size_t errorLen); // new italic stroke
